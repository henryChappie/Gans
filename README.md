<h1>The GANs Collection Package</h1>
近年来，对抗式生成网络得到了飞速的发展，每个月都会有新的结构诞生，这些不同的模型能够被应用到不同的领域，下面是目前所有的技术论文的地址，你可以点击下面的链接查看文章的具体信息。

## 热门Gans结构：
<img src='https://raw.githubusercontent.com/buriburisuri/ac-gan/master/png/architecture.png'/><hr>

<img src='https://camo.githubusercontent.com/e004d49943b2b1264496d5db1a9bff807afa8a68/687474703a2f2f6572696b6c696e6465726e6f72656e2e73652f696d616765732f646973636f67616e5f6172636869746563747572652e706e67'/><hr>

<img src='https://camo.githubusercontent.com/e8c023b62678aa244f1a474bf643c66c45ef0feb/687474703a2f2f6572696b6c696e6465726e6f72656e2e73652f696d616765732f706978327069785f6172636869746563747572652e706e67'/><hr>

<img src='https://camo.githubusercontent.com/07288b4b467fbf547c6757a448f8e786bf20f295/687474703a2f2f6572696b6c696e6465726e6f72656e2e73652f696d616765732f737570657272657367616e2e706e67'/><hr>

<img src='https://camo.githubusercontent.com/c653ddc55471557b851a7059540e80799fad7e29/687474703a2f2f6572696b6c696e6465726e6f72656e2e73652f696d616765732f6379636c6567616e2e706e67'/><hr>

<img src='https://github.com/eriklindernoren/PyTorch-GAN/raw/master/assets/bicyclegan_architecture.jpg'/><hr>
<img src='https://github.com/LantaoYu/SeqGAN/raw/master/figures/seqgan.png'/><hr>
<img src='https://github.com/hanzhanggit/StackGAN/raw/master/examples/framework.jpg'/><hr>
<img src='https://github.com/taoxugit/AttnGAN/raw/master/framework.png'/><hr>
<img src='https://github.com/heykeetae/Self-Attention-GAN/raw/master/image/main_model.PNG'/><hr>
<img src='https://github.com/CR-Gjx/LeakGAN/raw/master/figures/leakgan.png'/><hr>
<img src='https://github.com/DmitryUlyanov/AGE/raw/master/data/readme_pics/age.png'/><hr>
<img src='https://github.com/hanzhanggit/StackGAN-v2/raw/master/examples/framework.jpg'/><hr>
<img src='https://github.com/hwwang55/GraphGAN/raw/master/framework.jpg'/><hr>
...
* ACGAN  -  [基于生成对抗网络隐藏的无掩盖信息]（https://arxiv.org/pdf/1712.06951） 
...
* AE-OT  -  [生成模型的潜在空间最优传输]（https://arxiv.org/pdf/1809.05964） 
* AEGAN  -  [基于自动编码器的生成性对抗网的学习逆向映射]（https://arxiv.org/pdf/1703.10094） 
* AF-DCGAN  -  [AF-DCGAN：幅度特征深度卷积GAN用于室内定位系统中的指纹构建]（https://arxiv.org/pdf/1804.05347） 
* AffGAN  -  [图像超分辨率的摊销MAP推断]（https://arxiv.org/pdf/1610.04490） 
*目标 -  [通过对抗性信息最大化生成信息性和多样化的对话响应]（https://arxiv.org/pdf/1809.05972） 
* AL-CGAN  -  [学习从属性和语义布局生成室外场景的图像]（https://arxiv.org/pdf/1612.00215） 
* ALI  -  [对侧学习推理]（https://arxiv.org/pdf/1606.00704） （[github] （https://github.com/IshmaelBelghazi/ALI））
* AlignGAN  -  [AlignGAN：学习将跨域图像与条件生成对抗网络对齐]（https://arxiv.org/pdf/1707.01400） 
* AlphaGAN  -  [AlphaGAN：用于自然图像消光的生成对抗网络]（https://arxiv.org/pdf/1807.10088） 
* AM-GAN  -  [激活最大化生成性对抗网]（https://arxiv.org/pdf/1703.02000） 
* AmbientGAN  -  [AmbientGAN：有损测量的生成模型]（https://openreview.net/forum?id=Hy7fDog0b） （[github]（https://github.com/AshishBora/ambient-gan））
...
* ARAE  -  [用于生成离散结构的反向正则化自动编码器]（https://arxiv.org/pdf/1706.04223） （[github]（https://github.com/jakezhaojb/ARAE））
...
* AttGAN  -  [任意面部属性编辑：只改变你想要的]（https://arxiv.org/pdf/1711.10678） （[github]（https://github.com/LynnHo/AttGAN-Tensorflow））
* AttnGAN  -  [AttnGAN：使用注意生成对抗网络生成细粒度文本到图像]（https://arxiv.org/pdf/1711.10485） （[github]（https://github.com/taoxugit/AttnGAN））
...
* BGAN  -  [用于图像检索的二进制生成对抗网络]（https://arxiv.org/pdf/1708.04150） （[github]（https://github.com/htconquer/BGAN））
* Bi-GAN  -  [通过双生成对抗网络辅助遗传算法自主同时精炼深度神经网络参数]（https://arxiv.org/pdf/1809.10244） 
* BicycleGAN  -  [迈向多模式图像到图像翻译]（https://arxiv.org/pdf/1711.11586） （[github]（https://github.com/junyanz/BicycleGAN））
...
* BRE  -  [通过二值化表示熵（BRE）正则化改进GAN培训]（https://arxiv.org/pdf/1805.03644） （[github]（https://github.com/BorealisAI/bre-gan））
...
* C-RNN-GAN  -  [C-RNN-GAN：具有对抗训练的连续递归神经网络]（https://arxiv.org/pdf/1611.09904） （[github]（https://github.com/olofmogren/） C-RNN淦/））
* CA-GAN  -  [组合辅助草图逼真肖像生成]（https://arxiv.org/pdf/1712.00899） 
* CaloGAN  -  [CaloGAN：使用生成对抗网络在多层电磁量热仪中模拟3D高能粒子淋浴]（https://arxiv.org/pdf/1705.02355） （[github]（https://github.com/hep -lbdl / CaloGAN））
...
* CC-GAN  -  [具有上下文条件生成对抗网络的半监督学习]（https://arxiv.org/pdf/1611.06430） （[github]（https://github.com/edenton/cc-gan） ）
...
* CFG-GAN  -  [生成对抗模型的复合功能梯度学习]（https://arxiv.org/pdf/1801.06309） 
...
* CycleGAN  -  [使用周期一致的对抗网络进行不成对的图像到图像转换]（https://arxiv.org/pdf/1703.10593） （[github]（https://github.com/junyanz/CycleGAN））
...
* DCGAN  -  [使用深度卷积生成对抗网络进行无监督表示学习]（https://arxiv.org/pdf/1511.06434） （[github]（https://github.com/Newmu/dcgan_code））
* DE-GAN  -  [具有解码器 - 编码器输出噪声的生成性对抗网络]（https://arxiv.org/pdf/1807.03923） 
* DeblurGAN  -  [DeblurGAN：使用条件对抗网络进行盲目运动辩论]（https://arxiv.org/pdf/1711.07064） （[github]（https://github.com/KupynOrest/DeblurGAN））
* DeepFD  -  [学习检测野外假脸图像]（https://arxiv.org/pdf/1809.08754） 
* Defense-GAN  -  [Defense-GAN：使用生成模型保护对抗攻击性攻击的分类器]（https://arxiv.org/pdf/1805.06605） （[github]（https://github.com/kabkabm/defensegan））
* Defo-Net  -  [Defo-Net：使用生成对抗网络学习身体变形]（https://arxiv.org/pdf/1804.05928） 
* DeliGAN  -  [DeLiGAN：针对多样化和有限数据的生成性对抗网络]（https://arxiv.org/pdf/1706.02071） （[github]（https://github.com/val-iisc/deligan））
...
* DRAGAN  -  [如何训练您的DRAGAN]（https://arxiv.org/pdf/1705.07215） （[github]（https://github.com/kodalinaveen3/DRAGAN））
...
* ExposureGAN  -  [曝光：白盒照片后处理框架]（https://arxiv.org/pdf/1709.09602） （[github]（https://github.com/yuanming-hu/exposure））
...
* GAN  -  [Generative Adversarial Networks]（https://arxiv.org/pdf/1406.2661） （[github]（https://github.com/goodfeli/adversarial））
...
* GAN-ATV  -  [通过GAN进行艺术文本可视化的新方法]（https://arxiv.org/pdf/1710.10553） 
* GAN-CLS  -  [生成对抗文本到图像合成]（https://arxiv.org/pdf/1605.05396） （[github]（https://github.com/reedscot/icml2016））
* GAN-RS  -  [利用生成对抗网络实现水下机器视觉的定性提升]（https://arxiv.org/pdf/1712.00736） 
* GAN-SD  -  [虚拟淘宝：虚拟化现实世界的强化学习在线零售环境]（https://arxiv.org/pdf/1805.10000） 
* GAN-sep  -  [生物图像合成的GAN]（https://arxiv.org/pdf/1708.04692） （[github]（https://github.com/aosokin/biogans））
...
* GAWWN  -  [学习什么和在哪里绘制]（https://arxiv.org/pdf/1610.02454） （[github]（https://github.com/reedscot/nips2016））
...
* GP-GAN  -  [GP-GAN：迈向逼真的高分辨率图像混合]（https://arxiv.org/pdf/1703.07195） （[github]（https://github.com/wuhuikai/GP-GAN） ）
* GP-GAN  -  [GP-GAN：用于从地标合成脸部的性别保护GAN]（https://arxiv.org/pdf/1710.00962） 
* GPU  -  [正面未标记分类的生成对抗框架]（https://arxiv.org/pdf/1711.08054） 
* GRAN  -  [使用经常性对抗网络生成图像]（https://arxiv.org/pdf/1602.05110） （[github]（https://github.com/jiwoongim/GRAN））
...
* IAN  -  [使用内省对抗网络进行神经照片编辑]（https://arxiv.org/pdf/1609.07093） （[github]（https://github.com/ajbrock/Neural-Photo-Editor））
* IcGAN  -  [用于图像编辑的可逆条件GAN]（https://arxiv.org/pdf/1611.06355） （[github]（https://github.com/Guim3/IcGAN））
...
* Iterative-GAN  -  [两只一石一鸟：用GAN迭代学习面部属性]（https://arxiv.org/pdf/1711.06078） （[github]（https://github.com/punkcure/Iterative-GAN ））
...
* iVGAN  -  [通过在野外制作视频来了解我们的世界]（https://arxiv.org/pdf/1711.11453） （[github]（https://github.com/bernhard2202/improved-video-gan ））
...
* LAPGAN  -  [使用拉普拉斯金字塔的对抗网络的深度生成图像模型]（https://arxiv.org/pdf/1506.05751） （[github]（https://github.com/facebook/eyescream））
...
* MC-GAN  -  [用于少量字体样式传输的多内容GAN]（https://arxiv.org/pdf/1712.00516） （[github]（https://github.com/azadis/MC-GAN） ）
...
* MGAN  -  [马尔可夫生成对抗网络的预计算实时纹理合成]（https://arxiv.org/pdf/1604.04382） （[github]（https://github.com/chuanli11/MGANs））
...
* MinLGAN  -  [通过最小似然生成对抗网络进行异常检测]（https://arxiv.org/pdf/1808.00200） 
...
* pix2pix  -  [使用条件对抗网络进行图像到图像翻译]（https://arxiv.org/pdf/1611.07004） （[github]（https://github.com/phillipi/pix2pix））
* pix2pixHD  -  [高分辨率图像合成和条件GAN的语义操作]（https://arxiv.org/pdf/1711.11585） （[github]（https://github.com/NVIDIA/pix2pixHD））
...
* ReConNN  -  [通过重建神经网络重建有限样本的基于仿真的物理场]（https://arxiv.org/pdf/1805.00528） 
...
* RPGAN  -  [使用多个随机投影稳定GAN训练]（https://arxiv.org/pdf/1705.07831） （[github]（https://github.com/ayanc/rpgan））
...
* SalGAN  -  [SalGAN：生成对抗网络的视觉显着性预测]（https://arxiv.org/pdf/1701.01081） （[github]（https://github.com/imatge-upc/saliency-salgan-2017） ）
...
* SN-GAN  -  [生成对抗网络的频谱规范化]（https://drive.google.com/file/d/0B8HZ50DPgR3eSVV6YlF3XzQxSjQ/view） （[github]（https://github.com/pfnet-research/chainer） -GaN-LIB））
...
* StackGAN  -  [StackGAN：使用堆叠生成对抗网络的文本到照片般逼真的图像合成]（https://arxiv.org/pdf/1612.03242v1） （[github]（https://github.com/hanzhanggit/StackGAN） ）
* StainGAN  -  [StainGAN：数字组织学图像的染色样式转移]（https://arxiv.org/pdf/1804.01601） 
* StarGAN  -  [StarGAN：用于多域图像到图像转换的统一生成式对抗网络]（https://arxiv.org/pdf/1711.09020） （[github]（https://github.com/yunjey/StarGAN） ））
...
* TAC-GAN  -  [TAC-GAN  - 文本条件辅助分类器生成对抗网络]（https://arxiv.org/pdf/1703.06412v2） （[github]（https://github.com/dashayushman/TAC-GAN ））
...
* VariGAN  -  [从单视图生成多视图图像]（https://arxiv.org/pdf/1704.04886） 
* VAW-GAN  -  [使用变分自动编码Wasserstein生成对抗网络从未对齐语料库进行语音转换]（https://arxiv.org/pdf/1704.00849） 
* VEEGAN  -  [VEEGAN：使用隐式变分学习减少GAN中的模式崩溃]（https://arxiv.org/pdf/1705.07761） （[github]（https://github.com/akashgit/VEEGAN））
* VGAN  -  [使用场景动态生成视频]（https://arxiv.org/pdf/1609.02612） （[github]（https://github.com/cvondrick/videogan））
* VGAN  -  [生成对抗网络作为能量模型的变分训练]（https://arxiv.org/pdf/1611.01799） （[github]（https://github.com/Shuangfei/vgan））
